...
- [`yet-another-react-lightbox`](https://yet-another-react-lightbox.com) for the photo gallery; other motion is plain CSS (`@keyframes`, `prefers-reduced-motion`)
...
Section content is data-driven, so edit these rather than the components:
...
This repo pins a newer Next.js than most references describe. Check
